    ...
    return (
      <div id="data-selector-component" className="data-sources">
        ...
        <div style={styles.data_style}>
          ...
          <div
            className="button-group responsive-padding"
            style={styles.btns_style}
          >
            <select
              name="data_src"
              id="src-dropdown"
              onChange={e => this.changeSrc(e.target.value)}
            >
            ...
            <MyDS2Select
              name="data_src2"
              id="src2-dropdown"
              onChange={this.changeSrc2}
              source={this.state.src1SelectValue}
            />
            <select
              name="data_year"
              id="yr-dropdown"
              onChange={e => this.props.onYearChange(e.target.value)}
            >
