...
var census_sources = [{name: DATA_SRC2_TOTALPOP, value: 'Total Population'},
...
var bls_sources = [{name: DATA_SRC_BLS_EMPLOYMENT, value: 'Total Employment'}];
    ...
    fillOptions(props) {
        ...
        for (let i = 0; i < srcArray.length; i++)
        {
            ...
            this.state.options.push (
                 <option key={i} value={option.name}>{option.value}</option>
